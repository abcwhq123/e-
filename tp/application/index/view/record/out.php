...
<div class="wrapper">
  <div class="personalform">
     <div class="tzjl-tabs">
        ...
        <a id="form:j_idt39" href="{:url('Record/invest')}" title="投标中">投资中 </a> 
	  ...
	  <div class="c-tabs-cnt c-tzjlinfo" style=" padding-bottom:60px;">
          <table style="width: 100%">
            <tbody>
              ...
              <tbody id="page-data">
                    <tr>
                      <td align="left" width="40%" style="padding-left:10px; color:#4A4A4A;">45646<span class="tbline"></span> </td>
                      <td style="color:#0caffe;" align="center"><span class="tbline"></span><i>12313</i></td>
