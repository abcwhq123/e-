...
<!-- 页面头部 -->
<section>
  <div class="navigation-bar"> <a href="{:url('user/index')}" class="z-01"></a> <span>借款记录</span> <a href="{:url('index/index')}" class="z-02"></a> </div>
</section>
<!-- 中间内容 -->
<div class="wrapper">
          ...
          <table style="width: 100%">
            <tbody>
              ...
              <tr>
                ...
                <td align="right" style="padding-right:10px;"><a href="#">审核中</a></td>
              </tr>
			  <tr>
                <td align="left" width="40%" style="padding-left:10px; color:#4A4A4A;"> 2015-09-17 09:46 <span class="tbline"></span> </td>
                <td style="color:#0caffe;" align="center"><span class="tbline"></span><i>1,484</i></td>
